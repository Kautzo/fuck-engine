package cn.fuck.engine.captcha.behavior.renderer;

import cn.fuck.engine.captcha.behavior.definition.AbstractBehaviorRenderer;
import cn.fuck.engine.captcha.behavior.dto.JigsawCaptcha;
import cn.fuck.engine.captcha.core.algorithm.GaussianBlur;
import cn.fuck.engine.captcha.core.constants.CaptchaConstants;
import cn.fuck.engine.captcha.core.definition.domain.Coordinate;
...
import cn.fuck.engine.captcha.core.provider.RandomProvider;
...
public class JigsawCaptchaRenderer extends AbstractBehaviorRenderer<String, Coordinate> {
    ...
    private Metadata draw(BufferedImage originalImage, BufferedImage templateImage, String sliderImageBase64) {
        ...
        log.trace("[FUCK] |- Jigsaw captcha original image width is [{}], height is [{}].", originalImageWidth, originalImageHeight);
        log.trace("[FUCK] |- Jigsaw captcha template image width is [{}], height is [{}].", templateImageWidth, templateImageHeight);
        ...
        log.trace("[FUCK] |- Jigsaw captcha jigsaw image width is [{}], height is [{}].", jigsawImage.getWidth(), jigsawImage.getHeight());
    ...
    private Coordinate createImageMattingCoordinate(int originalImageWidth, int originalImageHeight, int templateImageWidth, int templateImageHeight) {
        ...
        log.debug("[FUCK] |- Jigsaw captcha image matting coordinate is x: [{}], y: [{}].", x, y);
