...
import cn.fuck.engine.captcha.graphic.definition.AbstractBaseGraphicRenderer;
import cn.fuck.engine.assistant.core.definition.constants.RegexPool;
...
public class ArithmeticCaptchaRenderer extends AbstractBaseGraphicRenderer {
    ...
    protected String[] getDrawCharacters() {
        ...
        try {
            ...
            log.error("[FUCK] |- Arithmetic png captcha eval expression error！", e);
        }
