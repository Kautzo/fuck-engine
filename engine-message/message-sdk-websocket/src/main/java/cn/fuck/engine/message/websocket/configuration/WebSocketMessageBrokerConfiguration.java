package cn.fuck.engine.message.websocket.configuration;

import cn.fuck.engine.message.websocket.interceptor.WebSocketAuthenticationHandshakeInterceptor;
import cn.fuck.engine.message.websocket.interceptor.WebSocketChannelInterceptor;
import cn.fuck.engine.message.websocket.interceptor.WebSocketPrincipalHandshakeHandler;
import cn.fuck.engine.message.websocket.properties.WebSocketProperties;
...
public class WebSocketMessageBrokerConfiguration extends AbstractSessionWebSocketMessageBrokerConfigurer<Session> {
    ...
    public void postConstruct() {
        log.debug("[FUCK] |- SDK [WebSocket Message Broker] Auto Configure.");
    }
...
//                .setClientPasscode("password");
        ...
        // 线程名前缀
        taskScheduler.setThreadNamePrefix("fuck-websocket-heartbeat-thread-");
        // 初始化
