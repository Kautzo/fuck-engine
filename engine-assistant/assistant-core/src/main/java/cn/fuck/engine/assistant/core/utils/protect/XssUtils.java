package cn.fuck.engine.assistant.core.utils.protect;
...
public class XssUtils {
    ...
    public static String cleaning(String taintedHTML) {
        ...
        log.trace("[FUCK] |- Antisamy process value from [{}] to [{}]", taintedHTML, result);
        return result;
    }
    ...
    private Policy createPolicy() {
        try {
            ...
            log.warn("[FUCK] |- Antisamy create policy error! {}", e.getMessage());
            return null;
        }
    }
    ...
    private String cleanHtml(String taintedHtml) {
        try {
            ...
            log.error("[FUCK] |- Antisamy scan catch error! {}", e.getMessage());
            return taintedHtml;
        }
    }
}
