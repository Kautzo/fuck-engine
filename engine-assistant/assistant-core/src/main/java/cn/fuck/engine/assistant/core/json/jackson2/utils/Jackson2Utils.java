package cn.fuck.engine.assistant.core.json.jackson2.utils;
...
public class Jackson2Utils {
    ...
    public static <T> String toJson(T domain) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 json processing error, when to json! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T toObject(String content, Class<T> valueType) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 json processing error, when to object with value type! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T toObject(String content, TypeReference<T> typeReference) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 json processing error, when to object with type reference! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static <T> T toObject(String content, JavaType javaType) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 json processing error, when to object with java type! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonNode toNode(String content) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 json processing error, when to node with string! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonNode toNode(JsonParser jsonParser) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 io error, when to node with json parser! {}", e.getMessage());
            return null;
        }
    }
    ...
    public static JsonParser createParser(String content) {
        try {
            ...
            logger.error("[FUCK] |- Jackson2 io error, when create parser! {}", e.getMessage());
            return null;
        }
    }
