 ...
 */
public class FuckSentinelInvocationHandler implements InvocationHandler {
    ...
    FuckSentinelInvocationHandler(Target<?> target, Map<Method, MethodHandler> dispatch,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof FuckSentinelInvocationHandler sentinelInvocationHandler) {
