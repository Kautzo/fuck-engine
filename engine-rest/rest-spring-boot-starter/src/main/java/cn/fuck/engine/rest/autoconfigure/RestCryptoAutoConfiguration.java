...
import cn.fuck.engine.rest.protect.configuration.HttpCryptoConfiguration;
...
public class RestCryptoAutoConfiguration {
    ...
    public void postConstruct() {
        log.info("[FUCK] |- Module [Rest Crypto] Auto Configure.");
        ...
        log.debug("[FUCK] |- Rest Crypto HandlerMethodArgumentResolver Auto Configure.");
