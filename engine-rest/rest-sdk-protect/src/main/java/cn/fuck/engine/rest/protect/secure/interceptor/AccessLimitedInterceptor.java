...
public class AccessLimitedInterceptor extends AbstractBaseHandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        log.trace("[FUCK] |- AccessLimitedInterceptor preHandle postProcess.");
        ...
        if (ObjectUtils.isNotEmpty(accessLimited)) {
            ...
            if (StringUtils.isNotBlank(annotationDuration)) {
                try {
                    ...
                    log.warn("[FUCK] |- AccessLimited duration value is incorrect, on api [{}].", request.getRequestURI());
                }
            }
            ...
            if (ObjectUtils.isEmpty(times) || times == 0L) {
                ...
                log.debug("[FUCK] |- AccessLimitedInterceptor request [{}] times.", times);
    ...
    private Duration calculateRemainingTime(Duration configuredDuration, String expireKey) {
        ...
        log.debug("[FUCK] |- AccessLimitedInterceptor operation interval [{}] millis.", interval);
