...
public class FeignRequestInterceptor implements RequestInterceptor {
        ...
        if (httpServletRequest != null) {
            ...
            if (!headers.containsKey(tenantIdHeader)) {
                ...
                if (StringUtils.isNotBlank(tenantId)) {
                    log.info("[FUCK] |- Feign Request Interceptor Tenant is : {}", tenantId);
            ...
            if (headers.containsKey(HttpHeaders.X_REQUEST_ID)) {
                ...
                log.info("[FUCK] |- Feign Request Interceptor Trace: {}", traceId);
            }
        }

        log.trace("[FUCK] |- Feign Request Interceptor [{}]", requestTemplate.toString());
    }
    ...
    private HttpServletRequest getHttpServletRequest() {
        try {
            ...
            log.error("[FUCK] |- Feign Request Interceptor can not get Request.");
            return null;
        }
    }
}
