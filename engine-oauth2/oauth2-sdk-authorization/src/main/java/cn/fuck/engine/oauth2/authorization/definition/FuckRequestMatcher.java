 ...
 */
@Slf4j
public final class FuckRequestMatcher implements RequestMatcher, Serializable {
     ...
     */
    public FuckRequestMatcher(String pattern) {
        this(pattern, null);
    }

    public FuckRequestMatcher(FuckRequest request) {
     ...
     */
    public FuckRequestMatcher(String pattern, String httpMethod) {
     ...
     */
    public FuckRequestMatcher(String pattern, String httpMethod, boolean caseSensitive) {
    ...
    public boolean matches(FuckRequest request) {
    ...
    public boolean equals(Object o) {
        ...
        FuckRequestMatcher that = (FuckRequestMatcher) o;
