package cn.fuck.engine.oauth2.authorization.introspector;
 ...
 */
@Slf4j
public class FuckOpaqueTokenIntrospector implements OpaqueTokenIntrospector {
    ...
    public FuckOpaqueTokenIntrospector(OAuth2ResourceServerProperties resourceServerProperties) {
     ...
     */
    public FuckOpaqueTokenIntrospector(String introspectionUri, String clientId, String clientSecret) {
     ...
     */
    public FuckOpaqueTokenIntrospector(String introspectionUri, RestOperations restOperations) {
        Assert.notNull(introspectionUri, "introspectionUri cannot be null");
    ...
    private OAuth2AuthenticatedPrincipal convertClaimsSet(Map<String, Object> claims) {
        ...
        claims.computeIfPresent(BaseConstants.AUTHORITIES, (k, v) -> {
            if (v instanceof ArrayList) {
                ...
                values.forEach(value -> authorities.add(new FuckGrantedAuthority(value)));
            }
            return v;
        });
