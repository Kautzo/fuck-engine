 ...
 */
public class FuckJwtGrantedAuthoritiesConverter implements Converter<Jwt, Collection<GrantedAuthority>> {
    ...
    public Collection<GrantedAuthority> convert(Jwt jwt) {
        ...
        for (String authority : getAuthorities(jwt)) {
            grantedAuthorities.add(new FuckGrantedAuthority(authority));
        }
