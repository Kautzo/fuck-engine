...
import cn.fuck.engine.oauth2.core.exception.SocialCredentialsParameterBindingFailedException;
...
public class OAuth2SocialCredentialsAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(Map<String, Object> additionalParameters) throws AuthenticationException {
        ...
        try {
            ...
            log.error("[FUCK] |- User name can not found for：[{}]", source);
            throw ex;
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (!registeredClient.getAuthorizationGrantTypes().contains(FuckGrantType.SOCIAL)) {
        ...
        OAuth2Authorization.Builder authorizationBuilder = OAuth2Authorization.withRegisteredClient(registeredClient)
                ...
                .authorizationGrantType(FuckGrantType.SOCIAL)
        ...
        log.debug("[FUCK] |- Social Credential returning OAuth2AccessTokenAuthenticationToken.");
