package cn.fuck.engine.oauth2.authentication.oidc;
 ...
 */
public class FuckOidcUserInfoMapper implements Function<OidcUserInfoAuthenticationContext, OidcUserInfo> {
