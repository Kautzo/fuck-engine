...
import cn.fuck.engine.oauth2.core.utils.OAuth2AuthorizationUtils;
...
/**
 * <p>Description: FuckAuthorization 转 OAuth2Authorization 转换器 </p>
 */
public class FuckToOAuth2AuthorizationConverter extends AbstractOAuth2EntityConverter<FuckAuthorization, OAuth2Authorization> {

    private final RegisteredClientRepository registeredClientRepository;

    public FuckToOAuth2AuthorizationConverter(OAuth2JacksonProcessor jacksonProcessor, RegisteredClientRepository registeredClientRepository) {
        super(jacksonProcessor);
        this.registeredClientRepository = registeredClientRepository;
    }

    @Override
    public OAuth2Authorization convert(FuckAuthorization entity) {
