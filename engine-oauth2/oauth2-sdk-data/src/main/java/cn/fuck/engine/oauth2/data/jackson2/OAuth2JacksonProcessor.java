...
public class OAuth2JacksonProcessor {
    ...
    public OAuth2JacksonProcessor() {
        ...
        objectMapper.registerModules(new FuckJackson2Module());
    ...
    public Map<String, Object> parseMap(String data) {
        try {
            ...
            log.error("[FUCK] |- OAuth2 jackson processing parseMap catch error {}", ex.getMessage());
    ...
    public String writeMap(Map<String, Object> data) {
        try {
            ...
            log.error("[FUCK] |- OAuth2 jackson processing writeMap catch error {}", ex.getMessage());
            throw new IllegalArgumentException(ex.getMessage(), ex);
        }
    }
}
