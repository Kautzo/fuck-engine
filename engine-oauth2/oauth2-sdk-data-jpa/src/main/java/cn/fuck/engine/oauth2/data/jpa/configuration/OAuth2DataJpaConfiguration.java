package cn.fuck.engine.oauth2.data.jpa.configuration;
...
import cn.fuck.engine.oauth2.data.jpa.service.HerodotusRegisteredClientService;
import cn.fuck.engine.oauth2.data.jpa.storage.JpaOAuth2AuthorizationConsentService;
import cn.fuck.engine.oauth2.data.jpa.storage.JpaOAuth2AuthorizationService;
import cn.fuck.engine.oauth2.data.jpa.storage.JpaRegisteredClientRepository;
...
@EntityScan(basePackages = {
        "cn.fuck.engine.oauth2.data.jpa.entity"
})
@EnableJpaRepositories(basePackages = {
        "cn.fuck.engine.oauth2.data.jpa.repository",
})
@ComponentScan(basePackages = {
        "cn.fuck.engine.oauth2.data.jpa.service",
})
