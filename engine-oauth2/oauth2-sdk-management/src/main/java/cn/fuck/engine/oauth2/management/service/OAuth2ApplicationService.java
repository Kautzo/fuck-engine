...
import cn.fuck.engine.oauth2.management.repository.OAuth2ApplicationRepository;
...
import cn.fuck.engine.oauth2.data.jpa.repository.HerodotusRegisteredClientRepository;
...
public class OAuth2ApplicationService extends BaseService<OAuth2Application, String> {
    ...
    public OAuth2Application saveAndFlush(OAuth2Application entity) {
        ...
        if (ObjectUtils.isNotEmpty(application)) {
            ...
            log.debug("[FUCK] |- OAuth2ApplicationService saveOrUpdate.");
            return application;
        } else {
            log.error("[FUCK] |- OAuth2ApplicationService saveOrUpdate error, rollback data!");
