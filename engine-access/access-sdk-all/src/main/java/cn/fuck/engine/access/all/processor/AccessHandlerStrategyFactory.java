...
import cn.fuck.engine.access.core.exception.AccessHandlerNotFoundException;
import cn.fuck.engine.access.core.exception.IllegalAccessArgumentException;
...
public class AccessHandlerStrategyFactory {
    ...
    public AccessUserDetails findAccessUserDetails(String source, AccessPrincipal accessPrincipal) {
        ...
        log.debug("[FUCK] |- AccessHandlerFactory findAccessUserDetails.");
