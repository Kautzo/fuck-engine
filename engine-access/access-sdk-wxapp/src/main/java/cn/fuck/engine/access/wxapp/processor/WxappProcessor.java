...
//                WxMaDefaultConfigImpl config = new WxMaRedisConfigImpl(new JedisPool());
        ...
        log.info("[FUCK] |- Bean [herodotus Weixin Mini App] Auto Configure.");
    }
    ...
    public WxMaService getWxMaService() {
        ...
        if (StringUtils.isBlank(appId)) {
            log.error("[FUCK] |- Must set [herodotus.platform.social.wxapp.default-app-id] property, or use getWxMaService(String appid)!");
    ...
    private WxMaJscode2SessionResult getSessionInfo(String code, WxMaService wxMaService) {
        try {
            ...
            log.debug("[FUCK] |- Weixin Mini App login successfully!");
            return sessionResult;
        } catch (WxErrorException e) {
            log.error("[FUCK] |- Weixin Mini App login failed! For reason: {}", e.getMessage());
            return null;
        }
    }
    ...
    private boolean checkUserInfo(String sessionKey, String rawData, String signature, WxMaService wxMaService) {
        if (wxMaService.getUserService().checkUserInfo(sessionKey, rawData, signature)) {
            log.debug("[FUCK] |- Weixin Mini App user info is valid!");
            return true;
        } else {
            log.warn("[FUCK] |- Weixin Mini App user check failed!");
            return false;
        }
    }
    ...
    private WxMaUserInfo getUserInfo(String sessionKey, String encryptedData, String iv, WxMaService wxMaService) {
        ...
        log.debug("[FUCK] |- Weixin Mini App get user info successfully!");
        return wxMaUserInfo;
    }
    ...
    private WxMaPhoneNumberInfo getPhoneNumberInfo(String sessionKey, String encryptedData, String iv, WxMaService wxMaService) {
        log.info("[FUCK] |- Weixin Mini App get encryptedData： {}", encryptedData);
        ...
        try {
            ...
            log.debug("[FUCK] |- Weixin Mini App get phone number successfully!");
            log.debug("[FUCK] |- WxMaPhoneNumberInfo : {}", wxMaPhoneNumberInfo.toString());
            return wxMaPhoneNumberInfo;
        } catch (Exception e) {
            log.error("[FUCK] |- Weixin Mini App get phone number failed!");
            return null;
        }
    }
    ...
    public WxMaJscode2SessionResult login(String code, String appId) {
        ...
        if (StringUtils.isNotBlank(code) && ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[FUCK] |- Weixin Mini App login failed, please check code param!");
            return null;
        }
    }
    ...
    public WxMaUserInfo getUserInfo(String appId, String sessionKey, String encryptedData, String iv, String rawData, String signature) {
        ...
        if (ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[FUCK] |- Weixin Mini App get user info failed!");
            return null;
        }
    }
    ...
    public WxMaPhoneNumberInfo getPhoneNumberInfo(String appId, String sessionKey, String encryptedData, String iv, String rawData, String signature) {
        ...
        if (ObjectUtils.isNotEmpty(wxMaService)) {
            ...
            log.error("[FUCK] |- Weixin Mini App get phone number info failed!");
            return null;
        }
    }
    ...
    public boolean sendSubscribeMessage(String appId, WxMaSubscribeMessage subscribeMessage) {
        try {
            ...
            log.debug("[FUCK] |- Send Subscribe Message Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[FUCK] |- Send Subscribe Message Failed!", e);
            return false;
        }
    }
    ...
    public boolean checkMessage(String appId, String message) {
        try {
            ...
            log.debug("[FUCK] |- Check Message Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[FUCK] |- Check Message Failed!", e);
            return false;
        }
    }
    ...
    public boolean checkImage(String appId, String fileUrl) {
        try {
            ...
            log.debug("[FUCK] |- Check Image Successfully!");
            return true;
        } catch (WxErrorException e) {
            log.debug("[FUCK] |- Check Image Failed! Detail is ：{}", e.getMessage());
            return false;
        }
    }
    ...
    public WxMaMediaAsyncCheckResult mediaAsyncCheck(String appId, String mediaUrl, int mediaType) {
        ...
        try {
            ...
            log.debug("[FUCK] |- Media Async Check Successfully!");
        } catch (WxErrorException e) {
            log.debug("[FUCK] |- Media Async Check Failed! Detail is ：{}", e.getMessage());
        }
